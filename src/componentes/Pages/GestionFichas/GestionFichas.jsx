...
export const GestionFichas = () => {
  ...
  if (loading)
    return <div className="loading-container">Cargando fichas...</div>;
  if (error) return <div className="error-message">{error}</div>;

  return (
    <div className="gestion-fichas-container">
      <div className="gestion-fichas-geader">
      ...
      {fichas.length === 0 ? (
        ...
        <div className="fichas-list">
          <button
            onClick={manejarAgregarFicha}
            className="agregar-ficha-button"
          >
            Agregar Ficha
          </button>
